...
zstyle ':completion:*' list-colors "${(s.:.)LS_COLORS}" # colors for completions
...
set -o prompt_subst # prompt string is first subjected to parameter expansion, command substitution and arithmetic expansion
